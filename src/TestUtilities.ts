...
function createRenderer(
  ...
  if (!inJestEnvironment()) {
    if (__DEV__) {
      // tslint:disable-next-line:no-console
      console.error("A test functions is being called at runtime.");
    }
    return null as any as ReactTestRenderer;
  }
...
export const RuntimeUtilities = { createRenderer };
